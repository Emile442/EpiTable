                            ...
                            <div x-show.transition="step != 'complete'">
                                ...
                                <div class="py-5">
                                        ...
                                        <div>
                                            @if($bookingToday)
                                                <div class="bg-blue-100 border-l-4 border-blue-500 text-blue-600 p-4 mt-4 my-5" role="alert">
                                                    <p><strong>Note:</strong> Vous avez une réservation pour <strong>aujourd'hui</strong> à <strong>{{ $bookingToday->slot->start_at->format('H:i') }}</strong>. Vous êtes <strong>{{ $bookingToday->table->name }}</strong>, place n°<strong>{{ $bookingToday->table_place }}</strong> </p>
                                                </div>
                                            @endif
                                    ...
                                    <div x-show.transition.in="step === 2">
                                        <div>
                                            <button type="button" class="focus:outline-none bg-gray-500 hover:bg-gray-700 text-white py-1 px-4 rounded-full mt-1" >
                                                Placement aléatoire
                                            </button>
                                            <button type="button" class="focus:outline-none bg-gray-500 hover:bg-gray-700 text-white py-1 px-4 rounded-full mt-1" >

<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input id="email" type="email" class="mt-1 block w-full opacity-50" read wire:model.defer="state.email" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <div class="relative">
                <select name="school" wire:model.defer="state.school" class="block appearance-none w-full border border-gray-300 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="school">
                    <option value="0" {{ old('school', $this->user->school) == '0' ? 'selected': '' }}>Epitech IT</option>

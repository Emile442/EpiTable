...
__webpack_require__(/*! ./jquery.seat-charts */ "./resources/js/jquery.seat-charts.js");

$(document).ready(function () {
  var conf = {
    map: ['a[,EL]aac', 'a__c', 'aaca'],
    seats: {
      a: {
        price: 99.99,
  ...
  var sc = $('.seat-map').seatCharts(conf);
  var sc2 = $('.seat-map2').seatCharts(conf); //Make all available 'c' seats unavailable

  sc.find('c.available').status('unavailable'); // sc.get(['2_6', '1_7']).node().css({});
...
/***/ "./resources/js/jquery.seat-charts.js":
/*!********************************************!*\
  !*** ./resources/js/jquery.seat-charts.js ***!
  \********************************************/
/*! no static exports found */
...
__webpack_require__(/*! /Users/emilelepetit/Documents/Sites.nosync/EpiTable/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Users/emilelepetit/Documents/Sites.nosync/EpiTable/resources/css/app.scss */"./resources/css/app.scss");
